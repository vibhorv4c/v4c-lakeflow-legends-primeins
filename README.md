...
![PrimeInsurance Architecture](docs/architecture_diagram.png) *(Note: Add your exported Draw.io diagram to the repo and link it here)*
...
4. **Serving & Consumption:**
   ...
   * **Views:** `v_aging_inventory`, `v_alert_scored`, `v_regional_demand_signal`.
